...
final class Version20180719175359 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE base_user (
            id INT AUTO_INCREMENT NOT NULL,
            ...
            UNIQUE INDEX UNIQ_1BF018B992FC23A8 (username_canonical),
            UNIQUE INDEX UNIQ_1BF018B9A0D96FBF (email_canonical),
            UNIQUE INDEX UNIQ_1BF018B9C05FB297 (confirmation_token),
            PRIMARY KEY(id)
        ) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE auth_code (
            id INT AUTO_INCREMENT NOT NULL,
            client_id INT NOT NULL,
            user_id INT DEFAULT NULL,
            token VARCHAR(255) NOT NULL,
